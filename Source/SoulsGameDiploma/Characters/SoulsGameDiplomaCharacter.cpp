...
#include "SoulsGameDiplomaCharacter.h"
...
void ASoulsGameDiplomaCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		UE_LOG(LogSoulsGameDiploma, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ASoulsGameDiplomaCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASoulsGameDiplomaCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASoulsGameDiplomaCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ASoulsGameDiplomaCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ASoulsGameDiplomaCharacter::DoJumpEnd()
{
